...
elseif region == 7
    ...
    regional_settings.bathy_mask = (bathy > 0);
    regional_settings.sig0_thresholds = [];
    regional_settings.Yn_thresholds = [20 24; 24 26; 26.3 26.6; 26.6 27; 27.25 27.6; 27.8 27.9; 27.9 28; 28 35];
...
elseif region == 8
    ...
    regional_settings.bathy_mask = (bathy > 0);
    regional_settings.sig0_thresholds = [];
    regional_settings.Yn_thresholds = [24 26; 26.3 26.7; 26.7 27; 27.3 27.6; 27.8 27.9; 27.9 28; 28 35];
...
elseif region == 12
    ...
    regional_settings.bathy_mask = (bathy > 0);
    regional_settings.sig0_thresholds = [];
    regional_settings.Yn_thresholds = [25 26.2; 26.2 27; 27.2 27.55; 27.85 27.95; 27.95 28.05; 28.05 35];
