...
sal = sal(351:end,201:end,:,:);
temp = temp(351:end,201:end,:,:);

z2d = z2d(351:end,201:end,:).*-1;


% Need a 4d depth var
% 
lon4d = repmat(lon2d(351:end,201:end),1,1,zN);
lat4d = repmat(lat2d(351:end,201:end),1,1,zN);
x=x(351:end);
y=y(201:end);
% Calc pressure
