function p1_calc_Yn_worker_1(path,file,out_dir)
...
sal = sal(1:350,1:200,:,:);
temp = temp(1:350,1:200,:,:);

z2d = z2d(1:350,1:200,:).*-1;


% Need a 4d depth var
% 
lon4d = repmat(lon2d(1:350,1:200),1,1,zN);
lat4d = repmat(lat2d(1:350,1:200),1,1,zN);
x=x(1:350);
y=y(1:200);
% Calc pressure
...
parfor (mm=1:tN,4)
    ...
    %% Write netcdf
    fileout = [out_dir,file(1:end-3),'_1.nc']; % <- Save data location
