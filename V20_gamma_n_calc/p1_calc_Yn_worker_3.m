...
sal = sal(351:end,1:200,:,:);
temp = temp(351:end,1:200,:,:);

z2d = z2d(351:end,1:200,:).*-1;


% Need a 4d depth var
% 
lon4d = repmat(lon2d(351:end,1:200),1,1,zN);
lat4d = repmat(lat2d(351:end,1:200),1,1,zN);
x=x(351:end);
y=y(1:200);
% Calc pressure
...
parfor (mm=1:tN,4)
    ...
    %% Write netcdf
    fileout = [out_dir,file(1:end-3),'_3.nc']; % <- Save data location
