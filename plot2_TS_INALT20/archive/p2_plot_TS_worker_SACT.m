...
disp('Calculating neutral density for plot (may take a while)')
...
pngname = (['plots/p2_INALT20_TS_coloured_time_REG_' num2str(region) '_' regional_settings.region_name]);
